...
DEFAULT_CAMERA_RECOVERY_ATTEMPTS = 2
DEFAULT_CAMERA_RECOVERY_DELAY_SECONDS = 0.25
MAX_CAMERA_RECOVERY_ATTEMPTS = 3
MAX_CAMERA_RECOVERY_DELAY_SECONDS = 2.0
MIN_USABLE_FRAME_DIMENSION = 32
BLACK_FRAME_MAX_PIXEL_VALUE = 2
